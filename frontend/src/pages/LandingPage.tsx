...
export function LandingPage() {
  ...
  const steps = [
    {
      num: "01",
      title: "Browse areas",
      desc: "Explore neighborhoods with statistics computed from the live property database.",
    },
    {
      num: "02",
      title: "Run prediction",
      desc: "Enter property details and get an AI-powered price estimate in seconds.",
    },
    {
      num: "03",
      title: "Decide smarter",
      desc: "Compare risk scores, favorites, and market trends before you invest.",
    },
  ];
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-100">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8">
          ...
          >
            <div className="mb-6 flex flex-wrap gap-2">
              ...
              {error && (
                <span className="stat-pill text-amber-400">
                  API: using cached view
                </span>
              )}
            </div>
            ...
            <h1 className="font-display text-4xl font-bold leading-[1.1] sm:text-5xl lg:text-[3.25rem]">
              Pakistan&apos;s{" "}
              <span className="gradient-text">smart property</span> intelligence
            </h1>

            <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-400">
              Live data, {dataset.length} property records, updated in real
              time.
            </p>
      ...
      <section
        id="features"
        className="relative border-t border-slate-800/60 py-20"
      >
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {steps.map((step, i) => (
              <motion.div
                ...
                className="cyber-glass rounded-2xl p-8"
              >
                <span className="font-display text-5xl font-bold text-slate-800">
                  {step.num}
                </span>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="mb-12 text-center">
            ...
            <p className="mt-3 text-slate-400">
              Counts derived from cities.reduce() on platform dataset
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="mt-3 text-sm text-slate-500">
                    {(
                      (city.property_count /
                        Math.max(metrics.totalListings, 1)) *
                      100
                    ).toFixed(1)}
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
          <motion.div
            {...fadeUp}
            className="cyber-glass rounded-3xl p-10 sm:p-14"
          >
            <h2 className="font-display text-3xl font-bold sm:text-4xl">
              Enter your role-based workspace
            </h2>
            <p className="mx-auto mt-4 max-w-lg text-slate-400">
              Investor, agent, and admin dashboards share this exact cyber
              design system.
            </p>
      ...
      <footer className="border-t border-slate-800/60 py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-slate-600">
            {formatNumber(metrics.totalListings)} listings · {metrics.cityCount}{" "}
            cities · live data
          </p>
        </div>
      </footer>
