...
mkdir -p /data
if [ ! -f /data/zameen-updated.csv ] && [ -f /seed/zameen-updated.csv ]; then
  echo "==> Copying seed dataset to writable /data/zameen-updated.csv"
  cp /seed/zameen-updated.csv /data/zameen-updated.csv
fi
